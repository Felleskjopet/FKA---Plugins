...
{
    public class pp_accountmanager : IPlugin
    {
        ...
        context.InputParameters["Target"] is Entity)
            {
                ...
                if (entity.LogicalName != "pp_accountmanager")
                    return;
                ...
                IOrganizationService service = serviceFactory.CreateOrganizationService(context.UserId);
                    ...
                    {
                        throw new InvalidPluginExecutionException("An error occurred in the plug-in: pp_accountmanager. " + ex.Message, ex);
                    }
